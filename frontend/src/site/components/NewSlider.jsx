...
const NewSlider = () => {
  ...
  return (
    <div className="cart-slider-container my-5">
      <Swiper
        modules={[Navigation, Pagination, Autoplay, Grid]}
        spaceBetween={20}
        slidesPerView={4} // تعداد ستون دسکتاپ
        grid={{ rows: 2, fill: "row" }} // دو ردیف
        navigation
        pagination={{ clickable: true }}
        autoplay={{ delay: 4000, disableOnInteraction: false }}
        loop={slides.length > 8} // حلقه وقتی اسلاید زیاد است
        breakpoints={{
          320: { slidesPerView: 1, grid: { rows: 2 }, spaceBetween: 10 }, // موبایل
          640: { slidesPerView: 2, grid: { rows: 2 }, spaceBetween: 15 }, // تبلت کوچک
          1024: { slidesPerView: 3, grid: { rows: 2 }, spaceBetween: 20 }, // لپ‌تاپ کوچک
          1200: { slidesPerView: 4, grid: { rows: 2 }, spaceBetween: 20 }, // دسکتاپ بزرگ
        }}
      >
        {slides.map((slide) => (
